copy lab.Users(book_id, bet_id, transaction_id, ticket_id, last_name, first_name, passport_series, passport_number, ban_status) FROM 'csv/users.csv' DELIMITER ',' CSV HEADER;
...
copy lab.Tickets(worker_last_name, worker_first_name, theme, ticket_status, ticket_date) FROM 'csv/tickets.csv' DELIMITER ',' CSV HEADER;